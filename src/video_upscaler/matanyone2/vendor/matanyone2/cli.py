# Clarity note: this is the upstream MatAnyone2 demo CLI entry point.
# It is intentionally vendored verbatim (incl. PIL/typer imports) for
# reference but is NOT imported by Clarity's own matanyone2 adapters
# (backend/processor/pytorch_backend); the inference path uses cv2 + numpy
# only. See VENDOR_NOTES.md for the dependency-audit rationale.
...
from .utils.inference_utils import gen_dilate, gen_erosion, read_frame_from_videos
from .inference.inference_core import InferenceCore
from .utils.get_default_model import get_matanyone2_model
